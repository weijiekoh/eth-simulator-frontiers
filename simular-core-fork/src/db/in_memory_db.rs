...
use ethers_core::types::{EIP1186ProofResponse, H256, U64, Bytes};
                    ...
                    Ok((
                        ...
                        SnapShotAccountRecord {
                            ...
                            proof: EIP1186ProofResponse {
                                address: ethers_core::types::H160::from(k.0.0),
                                balance: ethers_core::types::U256::from(v.info.balance.to_be_bytes::<32>().as_ref()),
                                code_hash: H256::from(v.info.code_hash.0),
                                nonce: U64::from(v.info.nonce),
                                storage_hash: H256::zero(), // Dummy value for in-memory DB
                                account_proof: vec![Bytes::from(H256::zero().as_bytes().to_vec())], // Dummy proof
                                storage_proof: vec![],
                            },
                        },
                    ))
